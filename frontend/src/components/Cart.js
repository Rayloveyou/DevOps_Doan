                                ...
                                <table className="w-100">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style={{
                                                height: '40px',
                                            }} className="text-end text-secondary fw-bold" > 3.000 ₫</td>
                                        </tr>
                                        <tr>
                                            <td><hr /></td>
                                            <td><hr /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-end text-secondary text-danger fw-bold fs-5" >{(totalPayment ? totalPayment + 3000 : 0).toLocaleString(
                                                "vi-VN",
                                                { style: "currency", currency: "VND" }
                                            )}</td>
                                        </tr>
                                        ...
                                        </tr>
                                        {
                                            ...
                                            <>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img type='button' onClick={() => handlePayMent(+totalPayment ? +totalPayment + 3000  : 0, quantityCheckbox, phoneNumberCustomer !== null ? phoneNumberCustomer : customerDetail?.phoneNumber, customerDetail?.name, addressCustomer !== null ? addressCustomer : customerDetail?.address)}
